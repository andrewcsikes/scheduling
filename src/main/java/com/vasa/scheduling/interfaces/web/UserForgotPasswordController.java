...
public class UserForgotPasswordController extends DefaultHandlerController{
	...
	public String save(Model model, HttpServletRequest request) {
		...
		if(user==null){
			...
			String message = "You are receiving this email because someone submitted the forgot password form on the VASA SWcheduling website. Your username is "+user.getUserName()+" and your password is "+user.getPassword();
			try{
